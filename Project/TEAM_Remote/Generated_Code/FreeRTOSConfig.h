...
#define configMINIMAL_STACK_SIZE                  (50) /* stack size in addressable stack units */
/*----------------------------------------------------------*/
/* Heap Memory */
...
#define configMAX_CO_ROUTINE_PRIORITIES           1 /* co-routine priorities can be from 0 up to this value-1 */
